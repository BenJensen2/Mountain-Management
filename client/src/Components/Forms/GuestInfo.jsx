...
const MemberForm = (props) => {
  ...
  return (
    <div className="guest-info" onSubmit={formHandler}>
      <h4 className="guest-info-header">Guest Info</h4>
      ...
      <div className="guest-inputs">
        ...
        <div className="column-2">
          ...
          <div className="city-state">
            <div className="form-item text-input" id="guest-city">
              <label>
                City
            <input type="text" value={city} onChange={e => setCity(e.target.value)} />
              </label>
            </div>
            <div className="form-item text-input" id="guest-state">
              <label>
                State
          ...
          <div className="country-zip">
            <div className="form-item text-input" id="guest-country">
              <label>
                Country
            <input type="text" value={country} onChange={e => setCountry(e.target.value)} />
              </label>
            </div>
            <div className="form-item text-input" id="guest-zip">
              <label>
                Zip
